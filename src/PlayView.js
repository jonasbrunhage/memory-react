...
function PlayView() {
  ...
  const procentMessage = () => {
    ...
    if (procent < 30) {
      return (
        <Quote
          mainQuote={"You need click on the pictures that are the same"}
          subQuote={"Maybe I should include the rules for this game"}
          percent={procent}
        />
      ...
      return (
        <Quote
          mainQuote={"This is a memory game"}
          subQuote={"Not the time for a walk down memory lane"}
          percent={procent}
        />
        // <div className="frame">
        //   <p className="playview-procent">{winPercentWithOneDecimal}%</p>
      ...
      return (
        <Quote
          mainQuote={"I dont know if that was bad or good"}
          subQuote={"Try again you should"}
          percent={procent}
        />
        // <div className="frame">
        //   <p className="playview-procent">{winPercentWithOneDecimal}%</p>
      ...
      return (
        <Quote
          mainQuote={"Like you solved a memory riddle"}
          subQuote={"You ended up right in the middle"}
          percent={procent}
        />
        // <div className="frame">
        //   <p className="playview-procent">{winPercentWithOneDecimal}%</p>
      ...
      return (
        <Quote
          mainQuote={"You right more the half the time"}
          subQuote={"With this skill in life you could really climb"}
          percent={procent}
        />
        // <div className="frame">
        //   <p className="playview-procent">{winPercentWithOneDecimal}%</p>
      ...
      return (
        <Quote
          mainQuote={"This is some impressive play"}
          subQuote={"Things really going your way"}
          percent={procent}
        />
        // <div className="frame">
        //   <p className="playview-procent">{winPercentWithOneDecimal}%</p>
      ...
      return (
        <Quote
          mainQuote={"My mind just exploded like a supernova"}
          subQuote={"You are a real life Pokémon Yoda"}
          percent={procent}
        />
        // <div className="frame">
        //   <p className="playview-procent">{winPercentWithOneDecimal}%</p>
    ...
    return (
      <Quote
        mainQuote={"You are a giant amongst men"}
        subQuote={"If not, you clairvoyant then"}
        percent={procent}
      />
      // <div className="frame">
      //   <p className="playview-procent">{winPercentWithOneDecimal}%</p>
